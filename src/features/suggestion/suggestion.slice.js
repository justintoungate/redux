...
export const fetchSuggestion =
  createAsyncThunk(/* Task 15: Complete the `createAsyncThunk()` function to load a suggestion from this URL: 
...
const options = {
  ...
  extraReducers: {
    ...
    pending, fulfilled, and rejected - for the `fetchSuggestion()` call */
